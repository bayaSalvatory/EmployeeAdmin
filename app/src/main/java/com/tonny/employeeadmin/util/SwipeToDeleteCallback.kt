...
import com.tonny.employeeadmin.ui.EmployeesAdapter

class SwipeToDeleteCallback(
    context: Context,
    private val employeesAdapter: EmployeesAdapter
) :
    ItemTouchHelper.SimpleCallback(ItemTouchHelper.END, ItemTouchHelper.START) {
    ...
    override fun onSwiped(viewHolder: RecyclerView.ViewHolder, direction: Int) {
        employeesAdapter.delete(viewHolder.adapterPosition)
    }
        ...
        when {
            dX > 0 -> { // Swiping to the right
                ...
                background.setBounds(
                    ...
                    itemView.left + dX.toInt() + backgroundCornerOffset, itemView.getBottom()
                )
            }
